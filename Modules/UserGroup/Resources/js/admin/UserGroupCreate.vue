<template>
    <div>
        ...
        <form @submit.prevent="onSubmit" v-if="!loading">
            ...
            <button :class="{'btn btn-primary submit_absolute': true, 'btn-loading': submit}" type="submit" :title="$t('UserGroup.save')"
                    :disabled="submit">
            ...
            <p class="text-right">
                ...
                <button :class="{'btn btn-primary': true, 'btn-loading': submit}" type="submit" :title="$t('UserGroup.save')"
                        :disabled="submit">
                    <i class="fas fa-save"></i>
                </button>
            </p>
        ...
        methods: {
            ...
            onSubmit() {
                ...
                axios({
                    ...
                    this.$bvToast.toast(this.$t('UserGroup.data_save'), {
                        title: this.$t('UserGroup.status'),
                        variant: 'info',
                        solid: true
                    })
