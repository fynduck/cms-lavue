<template>
    <b-tabs content-class="mt-3" v-if="Object.keys(settings).length">
        <b-tab :title="$t(`Article.${index}`)" v-for="(item, index) in settings" :key="index">
            ...
            <b-row class="mb-1 size" v-for="(size, key) in item.sizes" :key="key">
                <b-col cols="12" sm="4" class="mb-3">
                    <b-form-group :label="$t('Article.size_name')" :label-for="`name_${index}_${key}`">
                        <b-input-group>
                ...
                <b-col cols="12" sm="4" class="mb-3">
                    <label :for="`width_${index}_${key}`">{{ $t('Article.width') }}</label>
                ...
                <b-col cols="12" sm="4" class="mb-3">
                    <label :for="`height_${index}_${key}`">{{ $t('Article.height') }}</label>
            ...
            <b-row>
                <b-col md="4" class="mb-3">
                    <b-form-group :label="$t('Article.blur')" label-for="blur">
                        <b-input-group>
                            <b-form-input
                                id="blur"
                ...
                <b-col md="4" class="mb-3">
                    <b-form-group :label="$t('Article.brightness')" label-for="brightness">
                        <b-input-group>
                            <b-form-input
                                id="brightness"
            ...
            <b-row class="justify-content-between mt-4">
                <b-col>
                    <b-button variant="info" @click.prevent="addSize(index)" :title="$t('Article.add_size')">
                        <fa :icon="['fas', 'plus']"/>
                    </b-button>
                </b-col>
    ...
    methods: {
        ...
        saveSettings(index) {
            ...
            if (this.settings.hasOwnProperty(index)) {
                this.settings[index].type = index;
