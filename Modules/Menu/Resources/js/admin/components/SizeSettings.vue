        ...
        <b-tab :title="$t(`Menu.${index}`)" v-for="(item, index) in settings" :key="index">
            ...
            <b-row class="mb-1 size" v-for="(size, key) in item.sizes" :key="key">
                <b-col cols="12" sm="4" class="mb-3">
                    <b-form-group :label="$t('Menu.size_name')" :label-for="`name_${index}_${key}`">
                        <b-input-group>
                ...
                <b-col cols="12" sm="4" class="mb-3">
                    <label :for="`width_${index}_${key}`">{{ $t('Menu.width') }}</label>
                ...
                <b-col cols="12" sm="4" class="mb-3">
                    <label :for="`height_${index}_${key}`">{{ $t('Menu.height') }}</label>
            ...
            <b-row class="align-items-center">
                ...
                <b-col class="mb-3">
                    <b-form-group :label="$t('Menu.action')" label-for="action">
                        <b-form-select v-model="item.action" :options="resizes" size="sm" id="action"></b-form-select>
                    </b-form-group>
                </b-col>
                <b-col class="mb-3">
                    <b-form-group :label="$t('Menu.format')" label-for="encode">
